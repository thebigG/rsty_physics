...
func _ready():
	...
	code_link.text = "[url=https://github.com/thebigG/rsty_physics/blob/main/godot/sin_cos_anim.gd][/https://github.com/thebigG/rsty_physics/blob/main/godot/sin_cos_anim.gd]"

...
#	obj.rotate(PI)
	...
	code_link.text = "[url=https://github.com/thebigG/rsty_physics/blob/main/godot/scenes/arc_tan.gd][/https://github.com/thebigG/rsty_physics/blob/main/godot/scenes/arc_tan.gd]"

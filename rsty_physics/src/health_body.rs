...
use godot::engine::{CharacterBody2D, CharacterBody2DVirtual, Line2D, Line2DVirtual, Marker2D, PathFollow2D, RigidBody2D, Timer};
use godot::prelude::*;
// use rand::Rng as _;
...
//   }
//     #[func]
//     fn add(&mut self,  v2_x: f32, v2_y: f32) -> Vector2 {
//       Vector2{x: self.get_x() + v2_x, y: self.get_y() + v2_y}
//   }

//     #[func]
//     fn distance_to(&mut self, v2_x: f32, v2_y: f32) -> f32{
//         let dx = self.get_x() - v2_x;
//         let dy = self.get_y() - v2_y;

//         return f32::sqrt( f32::powf(dx, 2.0) + f32::powf(dy, 2.0))
//     }
//     #[func]
//     fn substract(&mut self, v2: RstyVector2)-> Vector2 {
...
// #[derive(GodotClass)]
// #[class(base=Node)]
// pub struct RstyParticle2{
//     position: RstyVector2,
//     velocity: RstyVector2,
//     #[base]
//     base: Base<Node>,
// }
...
#[godot_api]
impl CharacterBody2DVirtual for HealthBody2D {
